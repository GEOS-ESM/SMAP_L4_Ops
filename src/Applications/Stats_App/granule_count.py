...
file = '/discover/nobackup/projects/gmao/smap/SMAP_L4/SMAP/OPS/L1C_TB/listing_counts_new'
...
plt.title("SMAP L1C_TB Granule Counts")
plt.grid(True)
...
plt.savefig('granule_counts.png',dpi=150)
