...
#PBS -o <L4_SM_STREAM_directoryID>/runModel/output/SMAP_EASEv2_M09_GLOBAL/rc_out/Y%Y/M%m/<L4_SM_STREAM_version>.ldas_out.%Y%m%d_0000z.txt
##PBS -j oe
#PBS -q high_priority
...
mpirun -np 128 <L4_SM_STREAM_directoryID>/bin/LDASsa_mpi.x \
-restart .true. \
-spin .false. \
