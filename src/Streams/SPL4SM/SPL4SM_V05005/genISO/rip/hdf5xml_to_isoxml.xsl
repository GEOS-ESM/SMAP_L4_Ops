...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <gmd:DS_Series xmlns:gmi="http://www.isotc211.org/2005/gmi"
                ...
                <gmd:DS_DataSet>
                    <gmd:has>
                        <gmi:MI_Metadata>
                            ...
                            <gmd:contact xlink:href="http://gmao.gsfc.nasa.gov" xlink:title="Global Modeling and Assimilation Office"/>
                            <gmd:contact>
                                        ...
                                        <gmd:MD_DataIdentification>
                                            <gmd:citation>
                                                <xsl:call-template name="citation">
                                                    ...
                                                    <xsl:with-param name="ECS" select="hdf5:Attribute[@Name='shortName']/hdf5:Data/hdf5:DataFromFile"/>
                                                    <xsl:with-param name="ECSCode" select="'http://gov.nasa.esdis'"/>
                                                    <xsl:with-param name="ECSDesc" select="'A short name used by NASA''s Earth Observing System Data and Information System (EOSDIS) Core System (ECS) to identify the SMAP Level 4 Radar product.'"/>
                                    ...
                                    <xsl:for-each select="//hdf5:Group[@OBJ-XID=$objxid]">
                                        <gmd:MD_DataIdentification>
                                            ...
                                            <xsl:call-template name="type">
                                                <xsl:with-param name="tag">gmd:abstract</xsl:with-param>
                                                <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
                                                <xsl:with-param name="value" select="hdf5:Attribute[@Name='QAAbstract']/hdf5:Data/hdf5:DataFromFile"/>
                                            </xsl:call-template>
                                            <xsl:call-template name="type">
                                                <xsl:with-param name="tag">gmd:language</xsl:with-param>
                                                <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
            ...
            ===================================================================
            -->
            <!-- <gmd:seriesMetdata gco:nilReason="inapplicable"/> -->
            <xsl:call-template name="series"/>
        </gmd:DS_Series>
    </xsl:template>
    ...
    <xsl:template name="series">
        <gmd:seriesMetadata>
            <gmi:MI_Metadata>
                ...
                <gmd:contact xlink:href="http://www.nasa.gov" xlink:title="National Aeronautics and Space Administration"/>
                <gmd:contact>
                    <xsl:call-template name="responsible">
                        <xsl:with-param name="name" select="//hdf5:Group[@Name='SeriesIdentification']/hdf5:Attribute[@Name='resourceProviderOrganizationName']/hdf5:Data/hdf5:DataFromFile"/>
                            ...
                            <gmd:MD_DataIdentification>
                                <gmd:citation>
                                    <xsl:call-template name="citation">
                                        ...
                                        <xsl:with-param name="DOICode" select="'http://gov.nasa.esdis'"/>
                                        ...
                                        <xsl:with-param name="role" select="'resourceProvider'"/>
                                        <xsl:with-param name="series" select="hdf5:Attribute[@Name='SMAPShortName']/hdf5:Data/hdf5:DataFromFile"/>
                                        <xsl:with-param name="other" select="'true'"/>
                                    </xsl:call-template>
                                </gmd:citation>
                                <xsl:call-template name="type">
                                    <xsl:with-param name="tag">gmd:abstract</xsl:with-param>
        ...
        <gmd:DQ_DataQuality>
            ...
            <gmd:report>
                <xsl:call-template name="dqReport">
                    ...
                    <xsl:with-param name="value" select="subsequence($coval, position(), 1)"/>
                        ...
                        <gmi:LE_ProcessStep>
                            ...
                            <gmi:processingInformation>
                                <gmi:LE_Processing>
                                    <gmi:identifier>
                                        <xsl:call-template name="type">
                                            <xsl:with-param name="tag">gmd:MD_Identifier</xsl:with-param>
                                            <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
                                    ...
                                    <gmi:additionalAttributes>
                                        <gmi:LI_AdditionalAttributes>
                                            <xsl:call-template name="type">
                                                <xsl:with-param name="tag">gmi:TimeVariableEpoch</xsl:with-param>
                                                <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
                                            ...
                                            <xsl:call-template name="type">
                                                <xsl:with-param name="tag">gmi:epochJulianDate</xsl:with-param>
                                                <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
                                            ...
                                            <xsl:call-template name="type">
                                                <xsl:with-param name="tag">gmi:epochUTCDate</xsl:with-param>
                                                <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
                                    ...
                                    <gmi:algorithm>
                                        <gmi:LE_Algorithm>
                                            ...
                                            <xsl:call-template name="type">
                                                <xsl:with-param name="tag">gmi:version</xsl:with-param>
                                                <xsl:with-param name="type">gco:CharacterString</xsl:with-param>
                                                <xsl:with-param name="value" select="$root/hdf5:Group[@Name='ProcessStep']/hdf5:Attribute[@Name='algorithmVersionID']/hdf5:Data/hdf5:DataFromFile"/>
                                            </xsl:call-template>
                                        </gmi:LE_Algorithm>
                                    </gmi:algorithm>
                                </gmi:LE_Processing>
                                ...
                                <gmd:LE_Source>
                                    ...
                                    <gmd:sourceCitation>
                                        <xsl:call-template name="citation">
                                            ...
                                            <xsl:with-param name="dateType" select="'creation'"/>
                                            <xsl:with-param name="edition" select="$source/hdf5:Attribute[@Name='version']/hdf5:Data/hdf5:DataFromFile"/>
                                            <xsl:with-param name="identifier" select="$source/hdf5:Attribute[@Name='identifier']/hdf5:Data/hdf5:DataFromFile"/>
                                            <xsl:with-param name="identifierCode" select="'http://gmao.gsfc.nasa.gov'"/>
                                            <xsl:with-param name="identifierDesc" select="'A short name used by the Soil Moisture Active Passive (SMAP) mission to identify the Level 4 Radar product.'"/>
                                            <xsl:with-param name="DOI" select="$source/hdf5:Attribute[@Name='DOI']/hdf5:Data/hdf5:DataFromFile"/>
                                            <xsl:with-param name="DOIDesc" select="'A Digital Object Identifier (DOI) that provides a persistent interoperable means to locate the SMAP Level 4 Radar data product.'"/>
                                        </xsl:call-template>
                                    </gmd:sourceCitation>
                                </gmd:LE_Source>
            ...
            <gmi:MI_AcquisitionInformation>
                <gmi:platform>
                    <gmi:MI_Platform>
                        ...
                        <gmi:position/>
                        <xsl:call-template name="type">
                            <xsl:with-param name="tag">gmi:antennaRotationRate</xsl:with-param>
                            <xsl:with-param name="type">gco:Real</xsl:with-param>
                            <xsl:with-param name="value" select="hdf5:Group[@Name='platform']/hdf5:Attribute[@Name='antennaRotationRate']/hdf5:Data/hdf5:DataFromFile"/>
                        </xsl:call-template>
                    </gmi:MI_Platform>
                </gmi:platform>
            </gmi:MI_AcquisitionInformation>
            ...
            <gmd:result>
                ...
                <gmd:DQ_QuantitativeResult>
                    <gmd:valueUnit>
                        <xsl:choose>
                            <xsl:when test="$first">
                            <gmx:ML_DerivedUnit xmlns:ns1="http://www.opengis.net/gml/3.2">
                                <xsl:attribute name="ns1:id">
                                    <xsl:value-of select="translate(normalize-space($valueUnit),'&quot;','')"/>
                                </xsl:attribute>
                                <identifier xmlns="http://www.opengis.net/gml/3.2" codeSpace=""/>
                                <derivationUnitTerm xmlns:ns1="http://www.opengis.net/gml/3.2'">
                        ...
                        <xsl:otherwise>
                            <gmx:ML_DerivedUnit>
                                ...
                                <gml:identifier codeSpace="nasa">%</gml:identifier>
                    ...
                    <gmd:value>
                        <gco:Record>
                            ...
                            <xsl:call-template name="tag">
                                <xsl:with-param name="value" select="$valueType"/>
                                <xsl:with-param name="tag" select="'gco:RecordType'"/>
                            </xsl:call-template>
                        </gco:Record>
                    </gmd:value>
                </gmd:DQ_QuantitativeResult>
        ...
        <gmd:axisDimensionProperties>
            <gmd:MD_Dimension>
                ...
                <gmd:resolution>
                      <gco:Length>
                          <xsl:attribute name="uom">
                              <xsl:value-of select="substring-after($resolution,' ')"/>
                          </xsl:attribute>
        ...
        <gmd:CI_Citation>
            ...
            <gmd:identifier>
                <gmd:MD_Identifier>
                    ...
                    <!--
                    <xsl:if test="$identifierDesc = 'yes'">
                        <gmd:description>
                            <gco:CharacterString>A short name used by the Soil Moisture Active Passive (SMAP) mission to identify the Level 4 Radar product.</gco:CharacterString>
                        </gmd:description>
                    </xsl:if>
                    -->
                </gmd:MD_Identifier>
            ...
            <gmd:identifier>
                <gmd:MD_Identifier>
                    ...
                    <!--
                    <xsl:if test="$ECSDesc = 'yes'">
                        <gmd:description>
                            <gco:CharacterString>A short name used by NASA's Earth Observing System Data and Information System (EOSDIS) Core System (ECS) to identify the SMAP Level 4 Radar product.</gco:CharacterString>
                        </gmd:description>
                    </xsl:if>
                    -->
                </gmd:MD_Identifier>
            ...
            <gmd:identifier>
                <gmd:MD_Identifier>
                    ...
                    <!--
                    <xsl:if test="$DOIDesc = 'yes'">
                        <gmd:description>
                            <gco:CharacterString>A Digital Object Identifier (DOI) that provides a persistent interoperable means to locate the SMAP Level 4 Radar data product.</gco:CharacterString>
                        </gmd:description>
                    </xsl:if>
                    -->
                </gmd:MD_Identifier>
            ...
            <gmd:otherCitationDetails>
                <gco:CharacterString>The launch ready Release of the SMAP Level 4 Surface and Root Zone Soil Moisture Science Processing Software.</gco:CharacterString>
            </gmd:otherCitationDetails>
            </xsl:if>
        </gmd:CI_Citation>
    </xsl:template>
