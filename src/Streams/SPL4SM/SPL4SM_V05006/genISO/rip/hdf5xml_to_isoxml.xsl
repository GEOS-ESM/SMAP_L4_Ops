...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="fi">
        <xsl:choose>
            ...
            <xsl:when test="contains($filename, 'C_MD')">
    ...
    <xsl:template name="series">
        <gmd:seriesMetadata>
            <gmi:MI_Metadata>
                ...
                <gmd:contact>
                    <xsl:call-template name="responsible">
                        <xsl:with-param name="name" select="'NSIDC DAAC &gt; National Snow and Ice Data Center DAAC'"/>
